        ...
        <div className="sticky top-6 space-y-6">
          ...
          <div className="space-y-3 pt-4">
            ...
            <button
              ...
              className="w-full py-2.5 px-4 rounded-lg border border-gray-300 bg-white text-gray-700 hover:bg-gray-50 transition-colors flex items-center justify-center gap-2"
            >
              <Bookmark className={`w-5 h-5 ${isFavorite ? 'fill-current' : ''}`} />
              {isFavorite ? 'Đã lưu' : 'Lưu để xem sau'}
            </button>
          </div>
