...
CREATE TABLE `admins` (
  ...
  `group_id` bigint(20) unsigned DEFAULT NULL COMMENT 'ID nh├│m cho Admin CA Team',
  PRIMARY KEY (`id`),
...
CREATE TABLE `calendars` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `job_application_id` bigint(20) unsigned NOT NULL COMMENT 'ID cß╗ºa job_application li├¬n quan lß╗ïch hß║╣n',
  `admin_id` bigint(20) unsigned DEFAULT NULL COMMENT 'Admin phß╗Ñ tr├ích lß╗ïch hß║╣n',
  `collaborator_id` bigint(20) unsigned DEFAULT NULL COMMENT 'CTV li├¬n quan lß╗ïch hß║╣n',
  `event_type` tinyint(4) NOT NULL DEFAULT 1 COMMENT '1: Interview, 2: Nyusha, 3: Kh├íc',
  `title` varchar(255) NOT NULL COMMENT 'Tiêu đề',
  `description` text DEFAULT NULL COMMENT 'Ghi ch├║ chi tiß║┐t cho lß╗ïch hß║╣n',
...
CREATE TABLE `job_applications` (
  ...
  `title` text DEFAULT NULL COMMENT 'Ti├¬u ─æß╗ü',
